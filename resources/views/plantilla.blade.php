...
<head>
  ...
  <script src="<?php echo asset('admin/assets/js/core/jquery.min.js') ?>"></script>
      ...
      <link href="<?php echo asset('sweetalert2/dist/sweetalert2.css') ?>" rel="stylesheet">
      <link href="<?php echo asset('sweetalert2/css/animate.css') ?> " rel="stylesheet">
      <script src="<?php echo asset('sweetalert2/dist/sweetalert2.js') ?> "></script>
      <script src="<?php echo asset('sweetalert2/js/codigo.js') ?> "></script>
